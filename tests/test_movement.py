...
def test_validate_wanted_pawn():
    with pytest.raises(PawnsError):
        Movement._validate_wanted_pawn('cat')
...
def test_diagonal_movement_to_left_up():
    pawns = [
        ...
        [SECOND_COLOR, SECOND_COLOR, SECOND_COLOR, SECOND_COLOR, SECOND_COLOR, SECOND_COLOR, SECOND_COLOR, SECOND_COLOR,
         SECOND_COLOR],
        [SECOND_COLOR, FIRST_COLOR, SECOND_COLOR, FIRST_COLOR, EMPTY_COLOR, SECOND_COLOR, FIRST_COLOR, SECOND_COLOR,
         FIRST_COLOR],
...
def test_diagonal_movement_to_left_up_validate():
    ...
    with pytest.raises(PawnsError):
        Movement.diagonal_movement_to_left_up(pawns, 3, 5, 'cat')
...
def test_up_movement_validate():
    ...
    with pytest.raises(PawnsError):
        Movement.up_movement(pawns, 3, 4, 'cat')
...
def test_diagonal_movement_to_right_up_validate():
    ...
    with pytest.raises(PawnsError):
        Movement.diagonal_movement_to_right_up(pawns, 3, 3, 'cat')
...
def test_sideways_movement_to_right_validate():
    ...
    with pytest.raises(PawnsError):
        Movement.sideways_movement_to_right(pawns, 2, 3, 'cat')
...
def test_diagonal_movement_to_right_down_validate():
    ...
    with pytest.raises(PawnsError):
        Movement.diagonal_movement_to_right_down(pawns, 1, 3, 'cat')
...
def test_down_movement_validate():
    ...
    with pytest.raises(PawnsError):
        Movement.down_movement(pawns, 1, 4, 'cat')
...
def test_diagonal_movement_to_left_down_validate():
    ...
    with pytest.raises(PawnsError):
        Movement.diagonal_movement_to_left_down(pawns, 1, 5, 'cat')
...
def test_sideways_movement_to_left_validate():
    ...
    with pytest.raises(PawnsError):
        Movement.sideways_movement_to_left(pawns, 2, 5, 'cat')
